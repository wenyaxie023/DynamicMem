    ...
    "apps": [
        {
            ...
            "apis": [
                ...
                {
                    "api_name": "AddToWishlist",
                    "description": "Add a product to the wishlist for future consideration",
                    "selection_hint": [
                        "Deferred purchase intentions",
                        "Price sensitivity and waiting for deals",
                        "Gift ideas and special occasion planning",
                        "Product interest tracking behavior",
                    ],
                },
                {
                    "api_name": "Checkout",
                ...
                },
                {
                    ...
                    "description": "Write a review for a purchased product with rating and text feedback",
                    "selection_hint": [
                        "Product satisfaction and feedback willingness",
                        "Review writing behavior and engagement",
                        "Quality standards and expectations",
                        "Community contribution and helpfulness",
                    ],
                },
            ],
        },

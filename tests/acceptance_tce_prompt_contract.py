...
class TcePromptContractAcceptance(unittest.TestCase):
    ...
    def test_task_c_v2_generation_and_validation_prompts_follow_checklist_and_structured_schema(self) -> None:
        ...
        self.assertIn("Draft a specific reminder message for the user in this scenario.", generation_prompt)
        ...
        self.assertIn("Help the user set the search filters in this scenario.", info_prompt)
        ...
        self.assertIn("Help the user complete the setup or form fields in this scenario.", action_prompt)
    ...
    def test_task_c_v2_structured_answer_prompts_use_output_envelope(self) -> None:
        ...
        self.assertIn("specific and complete assistant message", user_comm_inline)
        self.assertIn('"answer": "<specific and complete assistant message>"', user_comm_inline)
    ...
    def test_task_c_v2_rewrite_prompt_preserves_structured_contract(self) -> None:
        ...
        self.assertIn("realistic search-filter task", rewrite_prompt)
        ...
        self.assertIn("realistic setup-or-form completion task", action_rewrite_prompt)
        ...
        self.assertIn("realistic search-filter task", structured_validation_prompt)
        ...
        self.assertIn("realistic setup-or-form completion task", action_validation_prompt)

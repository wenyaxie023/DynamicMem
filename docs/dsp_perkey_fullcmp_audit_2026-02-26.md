# DSP Full-Dict vs Per-Key Audit (2026-02-26)

Scope:
- Baseline: `rag`
- User: `001_user_001`
- Files compared:
  - `generation/rag/results/001_user_001/prediction/dynamic_state_prediction_results_topk5_queryv2_10_fullcmp.json`
  - `generation/rag/results/001_user_001/prediction/dynamic_state_prediction_results_topk5_queryv2_10_perkey.json`

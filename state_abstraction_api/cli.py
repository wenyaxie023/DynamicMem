...
def main() -> None:
    parser = argparse.ArgumentParser(description="State Abstraction API CLI")
    ...
    api = StateAbstractionAPI(args.benchmark)
    ...
    if args.command == "evaluate":
        ...
        print(
            ...
            f"snapshot_f1={result.get('summary', {}).get('snapshot_key_f1_mean', 0.0):.4f}, "
            f"delta_f1={result.get('summary', {}).get('delta_op_f1_mean', 0.0):.4f}"
        )
        return
